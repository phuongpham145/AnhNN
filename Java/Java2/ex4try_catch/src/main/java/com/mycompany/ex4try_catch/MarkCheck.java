 ...
 * @author Phuong
 */
public class MarkCheck extends javax.swing.JFrame {

    /**
     * Creates new form MarkCheck
     */
    public MarkCheck() {
        initComponents();
    ...
    private void btnCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckActionPerformed
        ...
        try {
            ...
            if(mark < 0 || mark > 10){
                JOptionPane.showMessageDialog(this, "Mark is false !");
                txtMark.setBackground(Color.red);
            } else {
                JOptionPane.showMessageDialog(this, "Mark is true !");
                txtMark.setBackground(Color.WHITE);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Data is invalite ! ");
            txtMark.setBackground(Color.blue);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MarkCheck.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
